-- Support neighboring-country selections in the race list filter.
-- County continues to filter domestic races; neighboring selections switch to origin_country.
